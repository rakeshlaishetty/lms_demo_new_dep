...
const data = [
  ...
  },
  {
    ...
    subs: [
        {
          label: 'Students',
          to: `${adminRoot}/your-class/class-students`
        },
        {
          label: 'Subjects',
          to: `${adminRoot}/your-class/class-subjects`
        },
        {
          label: 'Schedule',
          to: `${adminRoot}/your-class/class-schedule`
        },
        {
          label: 'Analytics',
          to: `${adminRoot}/your-class/class-analytics`
        }
    ]
  },
  {
    ...
    label: 'Assignments',
    to: `${adminRoot}/assignments`,
    subs: [
      {
        label: 'Your assignments',
        to: `${adminRoot}/assignments/view-assignments`
      },
      {
        label: 'Create assignment',
        to: `${adminRoot}/assignments/create-assignment`
      }
    ]
  },
  {
    ...
    subs: [
      {
        ...
        to: `${adminRoot}/attendance/class-attendance`
      },
      {
        label: 'Your attendance',
        to: `${adminRoot}/attendance/your-attendance`
      }
    ]
  },
  {
    ...
    subs: [
      {
        ...
        to: `${adminRoot}/library/teacher-library`
      },
      {
        label: 'Your Library',
        to: `${adminRoot}/attendance/your-library`
      }
    ]
  },
  {
