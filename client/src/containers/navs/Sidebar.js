...
import menuTeacher from 'constants/teacherMenu';
import menuStudent from 'constants/studentMenu';
  ...
  render() {
    ...
    return (
      <div className="sidebar">
        ...
        {  
          window.localStorage.getItem('user') === 'teacher' ?
          <div>
            <div className="main-menu">
          <div className="scroll">
            <PerfectScrollbar
            ...
            >
              <Nav vertical className="list-unstyled">
                {menuTeacher &&
                  this.filteredList(menuTeacher).map((item) => {
                    return (
                      <NavItem
                        key={item.id}
                        className={classnames({
...
{  
          window.localStorage.getItem('user') === 'student' ?
          <div>
            <div className="main-menu">
          <div className="scroll">
            <PerfectScrollbar
            ...
            >
              <Nav vertical className="list-unstyled">
                {menuStudent &&
                  this.filteredList(menuStudent).map((item) => {
                    return (
                      <NavItem
                        key={item.id}
                        className={classnames({
