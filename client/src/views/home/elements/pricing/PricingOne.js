...
const PricingOne = () => {
  return (
    <div className="row row--30 mt-5 mb-5 pt-5 pb-5">
          ...
          <div className="pricing-table-inner">
            ...
            <div className="pricing-body">
              <ul className="list-style--1">
                ...
                <li>
                  <FiCheck /> Keep 100% Royalties
                </li>
                <li>
                  <FiCheck /> App Development
                </li>
                <li>
                  <FiCheck /> Seo Friendly
                </li>
        ...
        <div className="rn-pricing">
          <div className="pricing-table-inner">
            ...
            <div className="pricing-body">
              <ul className="list-style--1">
                <li>
                  <FiCheck /> 50 PPC Campaigns
                </li>
                <li>
                  <FiCheck /> SEO Marketing
                </li>
                <li>
                  <FiCheck /> Marketing Agency
                </li>
